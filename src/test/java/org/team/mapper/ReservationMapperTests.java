...
public class ReservationMapperTests {
	...
	*/
	...
	/*
	 * @Test public void testInsert() { //새로운 예약 데이터 김철수 추가 출력 테스트 성공 ReservationDTO
	 * reservation = new ReservationDTO();
	 * reservation.setRdate("2024-12-06 10:00:00"); reservation.setCname("김철수");
	 * reservation.setCphone("010-1234-5678"); reservation.setAddress("울산 울주군 언양동");
